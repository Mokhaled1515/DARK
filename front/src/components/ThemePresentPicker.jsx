...
import { HERO_UI_THEME_PRESETS } from "../data/herouiThemepresest.js";
                ...
                {HERO_UI_THEME_PRESETS.map((p) => {
                  ...
                  return (
                    <button
                      ...
                      className={[
                        "relative cursor-pointer flex flex-col items-center gap-2 rounded-xl p-2 text-center transition-colors",
                        selected
